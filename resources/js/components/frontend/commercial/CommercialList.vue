                            ...
                            <div class="widget filter-widget">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-4 col-sm-6 col-12">
                                            <button class="btn v8" @click="getCommercial"> Search Property</button>
                                        </div>
                                    </div>
                        ...
                        <div class="sidebar-content-right py-40">
                            ...
                            <div class="item-wrapper pt-20">
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade  show active  property-list" id="list-view"  v-for="(data, index) in commercialList" :key="index">
                                        ...
                                        <!--pagination starts-->
                                            <Pagination :meta_data="meta_data" v-on:next="getCommercial"></Pagination>
                                        <!--pagination ends-->
                                        </div>
                                        </div>
                                        </div>
