                            ...
                            <div class="widget filter-widget">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-4 col-sm-6 col-12">
                                            <button class="btn v8" @click="getResedential"> Search Property</button>
                                        </div>
                                    </div>
                        ...
                        <div class="sidebar-content-right py-40">
                            ...
                            <div class="item-wrapper pt-20">
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade  show active  property-list" id="list-view"  v-for="(data, index) in resedentialList" :key="index">
                                       ...
                                       <Pagination :meta_data="meta_data" v-on:next="getResedential" > </Pagination>
                                        </div>
                                        </div>
                                        </div>
                                        </div>
                ...
                async getResedential(page = 1) 
                        {
                            ...
                            try 
                                ...
                                let {data} = await axios({
                                    method: "post",
                                    url: "/app/fe/resedentiallist",
                                    data: this.filters,
                                    params: {
                                        page
                                    }
                                });
                                this.resedentialList = data.data;
